...
public class GangInfoCMD extends SubcommandBase {
	@Override
	...
	public void perform(CommandSender sender, String[] args) {
		...
		Optional<Gang> gang = Gangs.getPlugin().getGangManager().getGangByName(gangName);
		if(!gang.isPresent()){
			Colorize.message(player, "&cThis is not a valid gang!");
			return;
		}
